(() => {
  ...
  window.CX_DATA = {
    ...
    tiles: [
      ...
      { page: "magazyn", tone: "green", icon: "warehouse", title: tx("Magazyn", "Warehouse", "Склад", "Склад", "Anbar", "Almacén", "Bodega", "Gudang", "गोदाम"), text: tx("Wejście, zdjęcie, zasady. Bez readera.", "Entrance, photo, rules. No reader.", "Вхід, фото, правила. Без рідера.", "Вход, фото, правила. Без ридера.", "Giriş, şəkil, qaydalar. Reader yoxdur.", "Entrada, foto, reglas. Sin reader.", "Pasukan, larawan, patakaran. Walang reader.", "Pintu masuk, foto, aturan. Tanpa reader.", "प्रवेश, फोटो, नियम। reader छैन।") },
    ...
    mapPhotos: [
      { tone: "blue", title: tx("Biuro / punkt spotkania", "Office / meeting point", "Офіс / місце зустрічі", "Офис / место встречи", "Ofis / görüş yeri", "Oficina / punto de encuentro", "Opisina / meeting point", "Kantor / titik temu", "कार्यालय / भेट्ने ठाउँ"), note: tx("Zdjęcia pomagają rozpoznać punkt pierwszego kontaktu.", "Photos help recognize the first contact point.", "Фото допомагають впізнати пункт першого контакту.", "Фото помогают узнать место первого контакта.", "Şəkillər ilk əlaqə yerini tanımağa kömək edir.", "Las fotos ayudan a reconocer el primer punto de contacto.", "Tumutulong ang larawan para makilala ang unang punto.", "Foto membantu mengenali titik kontak pertama.", "फोटोले पहिलो सम्पर्क ठाउँ चिन्न मद्दत गर्छ।"), photos: ["assets/inline/hotel_1.jpg", "assets/inline/hotel_2.jpg", "assets/inline/hotel_3.jpg", "assets/inline/hotel_4.jpg", "assets/inline/hotel_5.jpg"] },
      { tone: "green", title: tx("Wejście E1 / E2", "Entrance E1 / E2", "Вхід E1 / E2", "Вход E1 / E2", "Giriş E1 / E2", "Entrada E1 / E2", "Pasukan E1 / E2", "Pintu masuk E1 / E2", "प्रवेश E1 / E2"), note: tx("Zdjęcia wejścia dla etapów E1 i E2.", "Entrance photos for stages E1 and E2.", "Фото входу для етапів E1 і E2.", "Фото входа для этапов E1 и E2.", "E1 və E2 etapları üçün giriş şəkilləri.", "Fotos de entrada para E1 y E2.", "Larawan ng pasukan para sa E1 at E2.", "Foto pintu masuk untuk E1 dan E2.", "E1 र E2 का प्रवेश फोटो।"), photos: ["assets/inline/stage12_1.jpg", "assets/inline/stage12_2.jpg"] },
      { tone: "green", title: tx("Wejście E3 / E4", "Entrance E3 / E4", "Вхід E3 / E4", "Вход E3 / E4", "Giriş E3 / E4", "Entrada E3 / E4", "Pasukan E3 / E4", "Pintu masuk E3 / E4", "प्रवेश E3 / E4"), note: tx("Zdjęcia wejścia dla etapów E3 i E4.", "Entrance photos for stages E3 and E4.", "Фото входу для етапів E3 і E4.", "Фото входа для этапов E3 и E4.", "E3 və E4 etapları üçün giriş şəkilləri.", "Fotos de entrada para E3 y E4.", "Larawan ng pasukan para sa E3 at E4.", "Foto pintu masuk untuk E3 dan E4.", "E3 र E4 का प्रवेश फोटो।"), photos: ["assets/inline/stage34_1.jpg", "assets/inline/stage34_2.jpg", "assets/inline/stage34_3.jpg"] },
      { tone: "green", title: tx("Wejście E5", "Entrance E5", "Вхід E5", "Вход E5", "Giriş E5", "Entrada E5", "Pasukan E5", "Pintu masuk E5", "प्रवेश E5"), note: tx("Zdjęcia wejścia dla etapu E5.", "Entrance photos for stage E5.", "Фото входу для етапу E5.", "Фото входа для этапа E5.", "E5 etapı üçün giriş şəkilləri.", "Fotos de entrada para E5.", "Larawan ng pasukan para sa E5.", "Foto pintu masuk untuk E5.", "E5 का प्रवेश फोटो।"), photos: ["assets/inline/stage5_1.jpg", "assets/inline/stage5_2.jpg", "assets/inline/stage5_3.jpg", "assets/inline/stage5_4.jpg"] },
      { tone: "green", title: tx("Wejście E6", "Entrance E6", "Вхід E6", "Вход E6", "Giriş E6", "Entrada E6", "Pasukan E6", "Pintu masuk E6", "प्रवेश E6"), note: tx("Zdjęcia wejścia dla etapu E6.", "Entrance photos for stage E6.", "Фото входу для етапу E6.", "Фото входа для этапа E6.", "E6 etapı üçün giriş şəkilləri.", "Fotos de entrada para E6.", "Larawan ng pasukan para sa E6.", "Foto pintu masuk untuk E6.", "E6 का प्रवेश फोटो।"), photos: ["assets/inline/stage6_1.jpg", "assets/inline/stage6_2.jpg", "assets/inline/stage6_3.jpg", "assets/inline/stage6_4.jpg", "assets/inline/stage6_5.jpg"] }
    ],
    ...
    maps: [
      ...
      { key: "warehouse", tone: "yellow", title: tx("Magazyn - lokalizacja", "Warehouse - location", "Склад - локація", "Склад - локация", "Anbar - yer", "Almacén - ubicación", "Bodega - lokasyon", "Gudang - lokasi", "गोदाम - स्थान"), note: tx("To jest właściwe miejsce magazynu. Otwórz mapę i kieruj się do wejścia ze zdjęć poniżej.", "This is the correct warehouse location. Open the map and go to the entrance shown in the photos below.", "Це правильне місце складу. Відкрийте карту і прямуйте до входу з фото нижче.", "Это правильное место склада. Откройте карту и идите ко входу с фото ниже.", "Bu anbarın düzgün yeridir. Xəritəni açın və aşağıdakı şəkillərdəki girişə gedin.", "Esta es la ubicación correcta del almacén. Abre el mapa y ve a la entrada de las fotos abajo.", "Ito ang tamang lokasyon ng bodega. Buksan ang mapa at pumunta sa pasukan na nasa larawan sa ibaba.", "Ini lokasi gudang yang benar. Buka peta dan menuju pintu masuk seperti foto di bawah.", "यो गोदामको सही स्थान हो। नक्सा खोल्नुहोस् र तलका फोटोमा देखिएको प्रवेशतिर जानुहोस्।"), url: "https://maps.app.goo.gl/vVWEFUUHDt8qxzVw9" },
