...
const CACHE_NAME = CACHE_PREFIX + "20260716-dragon-single1-zb";
...
const CORE_ASSETS = [
  ...
  "./assets/css/training.css?v=20260716-dragon-single1-zb",
  "./assets/js/training-data.js?v=20260716-dragon-single1-zb",
  "./assets/js/location-custom.js?v=20260716-dragon-single1-zb",
  "./assets/js/training-app.js?v=20260716-dragon-single1-zb",
