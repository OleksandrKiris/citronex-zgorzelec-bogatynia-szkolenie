...
const CACHE_NAME = CACHE_PREFIX + "20260713-zgorzelec-bogatynia-lekarz1";
...
const CORE_ASSETS = [
  ...
  "./assets/js/location-custom.js?v=20260713-zgorzelec-bogatynia-lekarz1",
  "./assets/js/training-app.js?v=20260713-zgorzelec-bogatynia-lekarz1",
