...
const CACHE_NAME = CACHE_PREFIX + "20260715-zb-release-img1";
...
const CORE_ASSETS = [
  ...
  "./assets/css/training.css?v=20260715-zb-release-img1",
  "./assets/js/training-data.js?v=20260715-zb-release-img1",
  "./assets/js/location-custom.js?v=20260715-zb-release-img1",
  "./assets/js/training-app.js?v=20260715-zb-release-img1",
