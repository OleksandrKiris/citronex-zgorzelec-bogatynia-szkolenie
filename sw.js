...
const CACHE_NAME = CACHE_PREFIX + "20260713-citycollapse1-zgorzelec-bogatynia";
...
const CORE_ASSETS = [
  ...
  "./assets/css/training.css?v=20260713-citycollapse1-zgorzelec-bogatynia",
  "./assets/js/training-data.js?v=20260713-zgorzelec-bogatynia-lekarz1",
  "./assets/js/location-custom.js?v=20260713-citycollapse1-zgorzelec-bogatynia",
  "./assets/js/training-app.js?v=20260713-citycollapse1-zgorzelec-bogatynia",
